...
<main>
	...
	$last_name = filter_input(INPUT_POST, 'last_chosen');
	$update_customers = get_customers_by_last_name($last_name);
		$customer_id = $update_customers['customerID'];
    ...
    <form action="." method="post" id="aligned">
		...
		<input type="text" id="country_code" name="countryCode" 
